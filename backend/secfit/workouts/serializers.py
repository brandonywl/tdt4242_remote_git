...
class ExerciseSerializer(serializers.HyperlinkedModelSerializer):
    ...
    Serialized fields: url, id, name, description, duration, calories, muscle group, unit, instances, video, instructions
    ...
    class Meta:
        model = Exercise
        fields = ["url", "id", "name", "description", "duration", "calories", "muscleGroup", "unit", "instances", "video", "instructions", "owner", "owner_name"]
